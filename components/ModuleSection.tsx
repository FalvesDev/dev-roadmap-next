...
const ARTICLE_MAP: Record<string, string[]> = {
  ...
  "Lógica de Programação":       ["alg-1", "alg-3", "alg-4", "alg-2"],
  "OOP — Orientação a Objetos":  ["py-3", "clean-2"],
  "Testes":                      ["py-7"],
  "Async & Concorrência":        ["py-4", "async-1", "async-2"],
  "HTTP & APIs REST":            ["rest-3", "rest-1", "rest-2"],
  "TypeScript Core":             ["ts-1", "ts-2", "ts-3"],
  "Node.js & npm/pnpm":          ["node-1", "node-2", "async-1"],
  "HTML & CSS (mínimo necessário)": [],
  "React — Primeiro contato":    ["react-1", "react-2", "react-3"],
  "FastAPI (Python Backend)":    ["py-6", "py-5", "rest-2"],
  "Banco de Dados":              ["sql-1", "sql-2", "sql-3", "sql-4"],
  "Docker & Deploy Básico":      ["docker-2", "docker-1", "docker-3"],
  "Segurança Básica":            ["sec-1", "sec-2"],
  "Portfólio no GitHub":         ["career-2", "career-1", "career-4"],
  "Entrevistas Técnicas":        ["career-3", "alg-2"],
  "Clean Code":                  ["clean-1", "clean-2", "clean-3"],
